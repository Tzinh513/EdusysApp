...
public class ThongKeJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(cboKhoaHoc, javax.swing.GroupLayout.PREFERRED_SIZE, 443, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void fillTableBangDiem() {
        ...
        for (Object[] row : list) {
            ...
            model.addRow(new Object[]{row[0], row[1], diem, getXepLoai((float) diem)});
        }
    }
    ...
    private void fillComboBoxNam() {
        DefaultComboBoxModel model = (DefaultComboBoxModel) cboNamHoc.getModel();
        model.removeAllElements();
    ...
    private void fillTableDoanhThu() {
        ...
        model.setRowCount(0);
        int nam = (Integer) cboNamHoc.getSelectedItem();
